...
## 预期修改文件
- [x] `backend/app/cli_store.py` (新建)
- [x] `backend/app/cli_render.py` (新建)
- [x] `backend/app/cli.py` (新建)
- [x] `pyproject.toml` (修改: 添加 [project.scripts] + colorama 依赖)
- [x] `tests/python/unit/test_cli_store.py` (新建)
- [x] `tests/python/unit/test_cli_render.py` (新建)
- [x] `tests/python/unit/test_cli.py` (新建)
