...
### [ ] T-P0-1: 删除 `deep/recovery.py` 整文件
...
### [ ] T-P0-4: 删除 `subagents/base.py` 死代码
...
### [ ] T-P1-1: 修复 `milvus_client._on_skip` 闭包 bug
...
### [ ] T-P1-2: 修复 `mcp/client.py` tool_count
...
### [ ] T-P1-6: 合并 `rag_agent.py` + `web_agent.py`
...
### [ ] T-P1-7: 删除 `custom_agent.py` 重复工具
...
### [ ] T-P2-1: `run_team_path` 重写为 LangGraph `StateGraph`
...
### [ ] T-P2-2: `scheduler._run_subtask` 拆为节点
...
### [ ] T-P2-3: `Blackboard` 转 `TeamState(TypedDict)`
...
### [ ] T-P3-2: `_append_messages_to_checkpointer` 用正确 API
...
### [ ] T-P3-3: `rag_retrieve.py` 改用 LangChain 适配器
...
### [ ] T-P3-4: 接入 `RubricMiddleware` 到生产
