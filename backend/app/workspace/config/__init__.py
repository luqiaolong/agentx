...
典型用法::
    ...
    from app.workspace.config import generate_agentx_dir, load_project_config
...
from app.workspace.config.generator import GenerationResult, generate_agentx_dir
from app.workspace.config.loader import ProjectConfig, RuleFile, load_project_config
