...
_DEFAULT_FRONTEND_DEV_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看前端代码和配置文件\n"
...
_DEFAULT_BACKEND_DEV_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看后端代码和配置文件\n"
...
_DEFAULT_TESTER_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看代码和测试文件\n"
...
_DEFAULT_ARCHITECT_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看项目结构和关键代码\n"
...
_DEFAULT_DEVOPS_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看配置文件（Dockerfile/yaml/nginx.conf）\n"
...
_DEFAULT_UI_DESIGNER_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看样式代码（CSS/SCSS/Tailwind/Styled Components）\n"
...
_DEFAULT_PRODUCT_MANAGER_SYSTEM_PROMPT = (
    ...
    "4. 使用 read_file、ls、glob、grep 等工具查看项目文档（PRD/需求文档/会议纪要）\n"
...
_DEFAULT_TEAM_TOOLS = ["read_file", "ls", "glob", "grep", "web_search", "rag_retrieve"]
